...
const content: Record<LandingKey, LandingContent> = {
  oem: {
    ...
    description: "Alvora supports OEM and private-label lab-grown diamond programmes from its Surat benches, with documented specifications, calibrated profiles, and a practical brief-led process.",
    ...
    proof: ["Specification-led production", "Calibrated profiles with report details where supplied", "Matched layouts and parcels", "Confidential brief discussion available by agreement"],
  ...
  custom: {
    ...
    proof: ["Custom cut and calibration", "Matched layouts for repeatable settings", "Recut, repolish, and rework assessment", "Indicative specification-make timing of 5–10 working days, subject to capacity"],
  ...
  rings: {
    ...
    description: "Alvora supports jewellery teams with calibrated lab-grown diamond profiles and report details where supplied for ring, bridal, and repeatable setting programmes.",
  ...
  cvd: {
    ...
    description: "Alvora presents calibrated lab-grown diamond profiles for buyers evaluating CVD requirements, technical fit, and repeatable manufacture, with report details shown where supplied.",
    ...
    proof: ["Calibrated profiles with report details where supplied", "Technical profile review before enquiry", "Matched layouts and parcels", "Specification confirmed in writing"],
