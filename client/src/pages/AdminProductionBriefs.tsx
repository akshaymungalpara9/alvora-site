...
export default function AdminProductionBriefs() {
  ...
  const exportCsv = trpc.adminBriefs.exportCsv.useQuery(undefined, { enabled: false });
  ...
  const downloadCsv = async () => {
    ...
    if (!result.data) { setNotice("The export could not be prepared. Please try again."); return; }
    ...
    setNotice("Production-brief export downloaded.");
  };
