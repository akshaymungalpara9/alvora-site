...
const legalCopy = {
  privacy: {
    ...
    sections: [
      ...
      ["Currency and location", "We use your IP address only to choose the currency shown; it is not stored."],
...
export default function LegalPage({ page }: { page: LegalPageKind }) {
  ...
  return <div className="legal-shell">
    ...
    <main id="main-content" className="legal-main" tabIndex={-1}>
      ...
      {page === "privacy" ? <p>Country data: <a href="https://db-ip.com">IP Geolocation by DB-IP</a> (CC BY 4.0).</p> : null}
