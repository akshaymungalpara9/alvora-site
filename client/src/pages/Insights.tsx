...
export default function Insights({ articleSlug }: { articleSlug?: string }) {
  ...
  return <main className="insight-page"><header className="insight-header"><a className="brand" href="/"><img className="brand-mark" src="/assets/alvora-faceted-a.webp" alt="" /><span className="brand-name">ALVORA</span></a><a className="insight-back" href="/"><MoveLeft size={15} /> Alvora home</a></header><section className="insight-intro"><p className="eyebrow eyebrow-bright"><span />ALVORA / TRADE INSIGHTS</p><h1>Manufacturing notes are in preparation.</h1><p>Alvora is preparing concise production notes for trade buyers. In the meantime, current production availability, certificate links where supplied, and production briefs remain available.</p><a className="text-link" href="/availability">View current availability</a></section></main>;
}
