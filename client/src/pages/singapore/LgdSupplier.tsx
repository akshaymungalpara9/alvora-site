...
const JSON_LD = {
  ...
  description:
    "Alvora supplies Singapore with lab-grown diamonds across all major shapes, 0.10–5 ct+, D–G colour, IF–SI2 clarity, IGI or GIA certified, direct from Surat manufacture.",
  areaServed: "SG",
};
  ...
  return (
    <SpecialtyPageShell>
      <SpecialtyPageMeta
        ...
        description="Surat lab-grown diamond supplier for Singapore. Shapes, sizes 0.10–5 ct+, D–G colour, IF–SI2 clarity, cut grades, IGI or GIA. Trade catalogue on request."
      ...
      <section className="specialty-hero" aria-labelledby="sg-lgds-h1">
        ...
        <p className="specialty-hero-copy">
          ...
          to fancy, sizes from 0.10 ct melee to 5 ct and above, colour D–G, clarity IF–SI2, with
