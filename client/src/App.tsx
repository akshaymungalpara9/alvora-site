...
const COLLECTION_PATHS = ["/jewellery", "/engagement-rings", "/rings", "/earrings", "/necklaces", "/wedding-bands", "/jewellery/antique-cuts", "/jewellery/coloured-stones"];
