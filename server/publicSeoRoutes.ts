...
const SITEMAP_ENTRIES: SitemapEntry[] = [
  ...
  { path: "/calibrated-diamond-layouts", changefreq: "monthly", priority: "0.8" },
  { path: "/matched-pair-diamonds",      changefreq: "monthly", priority: "0.8" },
  { path: "/custom-cut-diamonds",        changefreq: "monthly", priority: "0.8" },
  { path: "/melee-diamonds",             changefreq: "monthly", priority: "0.8" },
  { path: "/certifications",             changefreq: "monthly", priority: "0.7" },
  { path: "/about",                      changefreq: "monthly", priority: "0.7" },
  { path: "/for-jewelry-brands",         changefreq: "monthly", priority: "0.8" },
