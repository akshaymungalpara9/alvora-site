---
slug: sourcing-lab-grown-diamonds-us-retailer
title: "Sourcing Lab-Grown Diamonds from India: A US Retailer's Guide"
metaDescription: "A first-time guide for US retailers importing lab-grown diamonds from India: import basics, documentation, communication expectations, supplier vetting and red flags."
...
- Red flags: prices far below any other quote, reluctance to certify, and pressure to pay a personal account.

## What crosses the border: duties and classification

Diamonds were duty-free into the United States for decades, but trade policy since 2025 changed the picture. Under the US–India framework announced in February 2026, cut and polished natural diamonds and gemstones were slated to become duty-free, but loose lab-grown diamonds were explicitly excluded from that exemption and remain subject to an 18% reciprocal tariff once the interim agreement takes effect [1](https://www.jckonline.com/editorial-article/u-s-tariffs-indian-diamonds-gems/). Trade coverage at the time noted the framework still required formal conclusion and that implementation details could shift [2](https://nationaljeweler.com/articles/14682-u-s-india-trade-deal-one-step-closer-to-being-finalized).
...
A professional export shipment from a Surat manufacturer should include: a commercial invoice stating carat weight, quantity, unit value and total; a packing list matching the invoice line-for-line; copies of the grading certificates (IGI or GIA) corresponding to the stones shipped; and a courier airway bill with tracking. For certified stones, check that certificate numbers on the paperwork match the certificates you received digitally. Discrepancies at this stage are common and cheap to fix before the parcel leaves, and expensive after.
...
- Quotes dramatically below every other supplier on an identical specification.
